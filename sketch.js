...
function speakit2() {
  ...
  textStyle(BOLD);
  if(!mylat){
    let mylatl =31 +random(1)
    mylat = mylatl.toFixed(4)
    let mylongl =121 + random(1)
    mylong =mylongl.toFixed(4)
  }
...
async function getStreet(sitee) {
  ...
  //img = await createImg("https://image.pollinations.ai/prompt/a%20view%20from%20the%20back%20of%20a%20taxi%20in%20a%20futuristic%20"+loc+"%20with%20a%20cool%20person%20in%20the%20backseat?width=800&height=800&nologo=true&seed="+floor(random(1026)),"street scene")
    ...
    img = await createImg("https://image.pollinations.ai/prompt/style%20line%20drawing%20digital%20color%20comicbook%20style,%201950s%20comic,%20detailed%20drawing,%20two%20life%20sized%20cardboard%20cutouts%of%20male%20workers%20with%20dark%20hair%20and%20a%20life%20sized%20cardboard%20cutout%20of%20a%20female%20artist%20worker%20with%20dark%20hair%20with%20yellow%20helments%20viewed%20from%20a%20distance%20working%20on%20a%20larg%20construction%20site%20in%20"+loc+"?width=800&height=800&nologo=true&seed="+floor(random(1026)),"street scene");
